package com.capgemini.serialisation.one_to_one.filehandler;

import java.io.File;
import java.io.IOException;
import java.rmi.StubNotFoundException;

import com.capgemini.serialisation.one_to_one.entity.*;
...
public class FileHandler {
	...
	public static void serialization(Student stu) throws StreamWriteException, DatabindException, IOException {
